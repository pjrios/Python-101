...
1. [Instalación Directa en el Dispositivo:](Documentacion/explicaciones/Instalación-directa-en-el-dispositivos.md)
...
2. [Cómo Instalar Anaconda y Crear un Entorno de Python:](https://github.com/pjrios/Como-Usar-Python/blob/main/Documentaci%C3%B3n/explicaciones/C%C3%B3mo%20Instalar%20Anaconda%20y%20Crear%20un%20Entorno%20de%20Python.md)
...
3. [Uso en Línea mediante Google Colab](Documentación/explicaciones/Uso-en-Línea-mediante-Google-Colab.md)
