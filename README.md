...
1. [Instalación Directa en el Dispositivo:](Documentación/explicaciones/Instalación-directa-en-el-dispositivos.md)
...
2. [Cómo Instalar Anaconda y Crear un Entorno de Python:](Documentación/explicaciones/Cómo-Instalar-Anaconda-y-Crear-un-Entorno-de-Python.md)
